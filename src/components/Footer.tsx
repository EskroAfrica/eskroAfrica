    ...
    <div className="bg-primary py-10">
      <div className='sm:flex justify-between w-[95%] mx-auto text-white'>
        ...
        <div className="basis-1/5 mb-5">
          ...
          <ul className=" text-sm text-neutral-400 space-y-5">
        ...
        <div className="basis-1/5 mb-5">
          ...
          <div className='flex justify-between flex-wrap'>
            {tags.map((tag, index) => <p className='border mb-2 border-neutral-400 rounded-sm px-1 py-1 text-sm md:text-base md:px-2 md:py-2 ' key={index}> {tag} </p>)}
          </div>
        </div>
