    ...
    return (
        <Modal modalKey='LoginModal'>
            <div className="py-10 px-5 flex flex-col justify-center items-center">
                ...
                <p className='text-3xl font-semibold pt-3'>Create a new account </p>
                <p className='text-xs text-neutral-500'>Full access to any of our products</p>
                <Button text='Continue with email' className='mt-5 font-light bg-primary text-baseColor px-10 w-full mx-auto py-4 rounded-lg' />
