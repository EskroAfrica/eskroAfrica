...
const NewsletterSection = () => {
  return (
    <div className='bg-neutral-100'>
      <div className='mx-auto w-[70%] xl:w-[50%] py-20'>
          <div className='pb-10'>
          <h3 className='text-4xl font-semibold lora-400 text-center text-primary'> Subscribe To Our Newsletter </h3>
          <p className='text-center w-[70%] lg:w-[60%] xl:w-[40%] mx-auto py-2'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus est molestias sit amet laboriosam. Eaque perferendis minus culpa aliquid veritatis!</p>
        </div>
        <div className="flex-row w-[70%] xl:w-[50%] mx-auto justify-center ">
