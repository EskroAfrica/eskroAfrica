...
import { IoMdCheckmarkCircle, IoMdCloseCircle, IoMdEye, IoMdEyeOff } from 'react-icons/io';
...
const ChangePassword = () => {
    ...
    return (
        <div className="mx-auto w-[90%] md:w-[30%] py-5 md:py-10 px-2 md:px-5 flex flex-col justify-center items-center">
